...
1. 강의 저장소 주소로 접속한다: `[TODO: 담당 교수 — 실제 GitHub 저장소 URL로 교체]`
...
📷 **캡처 필요 ⑩** — 강의 저장소 메인 화면(주차 폴더 목록)
![강의 저장소 메인 화면](img/w1s1_10_repo_main.png)
...
📷 **캡처 필요 ⑪** — Code 버튼과 Download ZIP 메뉴
![Download ZIP 메뉴](img/w1s1_11_download_zip.png)
